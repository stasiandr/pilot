#!/bin/bash
# Тесты алгоритмического ядра: индекс файлов и типов, fuzzy-поиск, .gitignore,
...
cp Sources/Pilot/Model/{FuzzyMatch,FileIndex,GitIgnore,AtomicCounter,PaletteItem,TypeIndex,DoubleShift}.swift "$TMP/Sources/coretests/"
